          ...
          "content": [
            {
              ...
              "strokeWidth": 1,
              "fill": "black",
              "text": "2021年4月19日、岐阜大学の\n「航空宇宙生産技術開発センター」の開所式典が行われました。\n東海国立大学機構と岐阜県が、航空宇宙産業に関わる人材の\n育成や研究開発を進めるため、全国に先駆けて設置したものです。",
              "fontStyle": "normal",
              "fontWeight": "normal",
              "fontSize": "22",
            ...
            },
            {
              ...
              "strokeWidth": 1,
              "fill": "black",
              "text": "この施設の延べ面積は1,520㎡で地上3階建ての鉄骨造であり、\nまた施設内には、航空機を流れ作業で組み立てるロボットアームや、\nAIを使って、熟練技術者の動きを再現するコンピューターなど\n最先端の装置が並び、学生らは実際に操作して学んだり、\n研究したりすることができます。",
              "fontStyle": "normal",
              "fontWeight": "normal",
              "fontSize": "22",
              "fontFamily": "sans-serif",
